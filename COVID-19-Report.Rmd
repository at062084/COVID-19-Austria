...
# TODO replace stat_smooth with rolling mean !!!
scaled=50000
ggplot(data=dwrm, aes(x=Date, y=newConfirmed/newTested)) +
  scale_x_date(limits=c(as.Date(strptime("2020-05-01",format="%Y-%m-%d")),NA)) +
  scale_y_continuous(limits=c(0,NA), breaks=seq(0,.1,by=.01), 
                     sec.axis = sec_axis(~ . *scaled, breaks=seq(0,10000,by=500))) +
  geom_point(size=1, color="blue") + 
  geom_line(color="blue") +
  #scale_y_continuous(limits=c(0,.11), breaks=seq(0,.15,by=.01)) +
  #stat_smooth(span=.4) +
  geom_point(aes(y=newTested/50000, color="red"), shape=1) +
  geom_line(aes(y=newTested/50000, color="red")) +
  geom_point(aes(y=newConfirmed/5000, color="green"), shape=2) +
  geom_line(aes(y=newConfirmed/5000, color="green"))
  #stat_smooth(aes(y=newConfirmed/1000), span=.4, col="red") +
  #stat_smooth(aes(y=newTested/50000), span=.4, col="green")
